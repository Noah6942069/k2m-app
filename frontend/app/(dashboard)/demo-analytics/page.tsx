    ...
    return (
        <div className="flex-1 p-6 space-y-6 overflow-y-auto">
            <div className="flex items-center justify-between mb-2">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-white mb-1">Fotky Demo</h1>
                    <p className="text-zinc-400">Real-time overview of support ticket performance.</p>
                </div>
                <button className="flex items-center gap-2 py-2 px-4 rounded-xl bg-gradient-to-r from-[#7C5CFC] to-[#5E43D8] text-white font-semibold shadow-lg shadow-[#7C5CFC]/25 hover:shadow-[#7C5CFC]/40 transition-all text-sm">
